...
public class HU29225_29226_Model {
	private Database db=new Database();

	public HU29225_29226_Model() {
	...
	public static final String aceptar_articulo = "UPDATE Articulo SET titulo = ?, palabras_clave = ?, resumen = ?, fichero = ?, fecha = ?, aceptado = TRUE WHERE id = ?";
	public static final String denegar_articulo = "UPDATE Articulo SET titulo = ?, palabras_clave = ?, resumen = ?, fichero = ?, fecha = ?, aceptado = FALSE WHERE id = ?";

	public void asignacion(int idRevisor, int idArticulo){
		db.executeUpdate(asignar_revisor,ultimoID(),idRevisor,idArticulo);
	}
	public void updateAceptaArticulo(String titulo,String palabras_clave,String resumen,String fichero, String fecha,int id) {
		db.executeUpdate(aceptar_articulo,titulo,palabras_clave,resumen,fichero,fecha,id);
	}
	public void updateDenegarArticulo(String titulo,String palabras_clave,String resumen,String fichero, String fecha,int id) {
		db.executeUpdate(denegar_articulo,titulo,palabras_clave,resumen,fichero,fecha,id);
	}

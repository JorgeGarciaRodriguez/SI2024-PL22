...
create table Autor_articulo(idAutor int not null, idArticulo int not null, envia boolean not null, revisa boolean not null, PRIMARY KEY(idAutor,idArticulo),
